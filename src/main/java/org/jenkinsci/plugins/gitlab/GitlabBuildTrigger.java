...
public final class GitlabBuildTrigger extends Trigger<AbstractProject<?, ?>> {
    ...
    public GitlabBuildTrigger(String cron, String projectPath) throws RecognitionException {
        super(cron);
        _cron = cron;
    ...
    public Future<?> startJob(GitlabCause cause) {
    ...
    public static final class GitlabBuildTriggerDescriptor extends TriggerDescriptor {
        ...
        public FormValidation doCheckBotUsername(@QueryParameter String value) {
            if (value == null || value.isEmpty()) {
                return FormValidation.error("You must provide a username for the Hudson user");
            }
        ...
        public FormValidation doCheckBotApiToken(@QueryParameter String value) {
            if (value == null || value.isEmpty()) {
                return FormValidation.error("You must provide an API token for the Hudson user");
            }
